...
<div class="main-div">
    <h2 class="title text-center">List of Offline Books</h2>
...
$sql="select count(*) as total from offlinebook";
...
$selectquery="select * from offlinebook";
...
?>
        ...
        <thead>
                    <tr>
                        <th>Total Number Of Offline Books</th>  
                    </tr>
                </thead>
                <tr>
        ...
        <button type="button" class="btn btn-secondary"><a href="offline_book_list_pdf.php" style="text-decoration: none;color:white">Print</a></button>
