...
if(isset($_POST["signup"]))
{
  ...
  $cid=mysqli_real_escape_string($con,$_POST["signup_id"]);
  ...
  elseif($check_email>0){
    ...
    $sql="INSERT INTO `admins`(`full_name`, `email`, `password`, `Contact_number`,`cid`) VALUES ('$full_name','$email','$password','$Contact_number','$cid')";
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="register-form">
        ...
        <div class="form-group">
          <input type="tel" placeholder="Class Id" class="form-control" name="signup_id" value="<?php echo $_POST["signup_id"] ;?>" required>
