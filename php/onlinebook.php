...
<div class="ratri">
     <div class="row">
       ...
       <div class="col-md-6">
       <form action="onlinebook.php"  method="post" >
            <div class="search">
            <div class="s1">
                <div class="s2">
...
<div class="main-div">
    <h2 class="title text-center">List of Online Books</h2>
...
$sql="select count(*) as total from onlinebook";
...
$selectquery="select * from onlinebook";
...
?>
        ...
        <thead>
                    <tr>
                        <th>Total Number Of Online Books</th>  
                    </tr>
                </thead>
                <tr>
